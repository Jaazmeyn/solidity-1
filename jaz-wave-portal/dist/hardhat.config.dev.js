...
require("@nomiclabs/hardhat-waffle"); // Import and configure dotenv
...
var API_URL = process.env.STAGING_ALCHEMY_KEY;
var PRIVATE_KEY = process.env.PRIVATE_KEY; // This is a sample Hardhat task. To learn how to create your own go to
